// flow-app.js v3.5 — Basado en v3.4 original + Filtros Globales en Checklist
console.log('flow-app.js v3.5 — Flow view with table inline editing & Global Filters');
...
if (window.__FLOW_APP_LOADED__) {
  ...
  function applyFlowFilters() {
    ...
    // =========================================================
    // MODIFICACION: Actualizar Checklist con datos filtrados
    // =========================================================
    if (currentDayFilter) {
  ...
  async function initFlowDashboard() {
    ...
    // ===============================================
    // CAMBIO IMPORTANTE: Listeners SOLO llaman a applyFlowFilters
    // ===============================================
